...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new Scaffold(
        appBar: new AppBar(
          title: new Text('Test Report Adviser'),
...
//            ),),
  ...
  Widget _buildImage() {
    return SizedBox(
      ...
      child: new Center(
        child: _file == null
            ? Text('No Image Selected.please! Select Image First')
  ...
  Future<Size> _getImageSize(Image image) {
    ...
    image.image.resolve(new ImageConfiguration()).addListener(ImageStreamListener((ImageInfo info, bool _) => completer.complete(
